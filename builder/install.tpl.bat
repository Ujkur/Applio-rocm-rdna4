...
powershell -NoProfile -EncodedCommand {{BLOB_GPU}}
...
powershell -NoProfile -EncodedCommand {{BLOB_DISK}}
...
powershell -NoProfile -EncodedCommand {{BLOB_SC}}
...
powershell -NoProfile -EncodedCommand {{BLOB_DLCHK}} >nul 2>nul
if not errorlevel 1 goto dl_ok
